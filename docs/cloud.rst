...
1. Make a pull request to https://github.com/pangeo-data/pangeo-docker-images
   ...
   at https://github.com/pangeo-data/pangeo-docker-images/blob/master/pangeo-notebook/environment.yml. If you do not want to add a new package, please raise an `issue <https://github.com/pangeo-data/pangeo-docker-images/issues>`_ so the next step can be triggered manually.
